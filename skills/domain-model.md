...
- `Guid Id` - **client-generated by default** (`Guid.CreateVersion7()`), not auto-generated by the DB. This is the scaffold default per **GR-16**; DB/store-generated keys (identity columns, `ValueGeneratedOnAdd`) are a deviation that needs an explicit developer request recorded in `.scaffold/DESIGN-DECISIONS.md`, and they change the aggregate-updater contract (see [../templates/updater-template.md](../templates/updater-template.md) section New children and EF Added state).
