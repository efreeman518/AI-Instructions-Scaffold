...
5. **Reinstall.** For each affected app: `py -3 scripts/install-to-project.py --target "<app>" --verify` (content-aware: unchanged files skipped, changed files overwritten and listed; see `/install-instructions`).
